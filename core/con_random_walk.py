...
class CON_random_walk(object):
    """
    class: CON_random_walk
    ...
    Parameters:
        ...
        -obj world:
            The world in which to move
        -obj log:
            The logger
        -dic config:
            The config file's dictionary
        -float dt:
    ...
    def __init__(self, vel, vel_var, r, r_var,
        ...
        self.__dimensions = self.__config['dimensions']*2 + 2
